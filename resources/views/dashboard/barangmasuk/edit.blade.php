                    ...
                    <div class="card-body">
                        <form action="{{ route('barangmasuk.update',$rsetBmasuk->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tgl_masuk') is-invalid @enderror" name="tgl_masuk" value="{{ old('tgl_masuk',$rsetBmasuk->tgl_masuk) }}" placeholder="Masukkan Tanggal Masuk Mobil">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('qty_masuk') is-invalid @enderror" name="qty_masuk" value="{{ old('qty_masuk',$rsetBmasuk->qty_masuk) }}" placeholder="Masukkan Jumlah Mobil Masuk">
