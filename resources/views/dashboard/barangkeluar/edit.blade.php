                    ...
                    <div class="card-body">
                        <form action="{{ route('barangkeluar.update',$rsetBkeluar->id) }}" method="POST" enctype="multipart/form-data">                    
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tgl_keluar') is-invalid @enderror" name="tgl_keluar" value="{{ old('tgl_keluar',$rsetBkeluar->tgl_keluar) }}" placeholder="keluarkan Tanggal Keluar Mobil">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('qty_keluar') is-invalid @enderror" name="qty_keluar" value="{{ old('qty_keluar',$rsetBkeluar->qty_keluar) }}" placeholder="keluarkan Jumlah Mobil Keluar">
